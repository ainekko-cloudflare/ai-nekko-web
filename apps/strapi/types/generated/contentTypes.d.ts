...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    contentNavigation: Schema.Attribute.Component<'article.content-navigation', true>;
    ...
    paragraphs: Schema.Attribute.Component<'article.paragraphs', true>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiBlogBlog extends Struct.SingleTypeSchema {
  ...
  attributes: {
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    featuredArticle: Schema.Attribute.Relation<'oneToOne', 'api::article.article'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
