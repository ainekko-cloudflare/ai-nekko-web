 ...
 * Version: 1.0.0
 * Docs: https://www.notion.so/litebox/Spinner-1-0-0-1b5ddb4193b94099a888c6d44595c697
 *
...
const Spinner = ({ className }: SpinnerProps) => {
  return (
    <svg
      aria-hidden='true'
      className={cn('inline animate-spin transition-all text-gray-400 fill-white size-4', className)}
      viewBox='0 0 100 101'
      fill='none'
